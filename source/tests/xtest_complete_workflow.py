...
def rek_workflow_configs(testing_env_variables):
    return [
        ...
        ('{"Name":"ImageWorkflow","Configuration": {"ValidationStage": {"MediainfoImage": {"Enabled": true}},"RekognitionStage": {"faceSearchImage": {"MediaType": "Image","Enabled": false, "CollectionId": "' + testing_env_variables['FACE_COLLECTION_ID'] + '"},"labelDetectionImage": {"MediaType": "Image","Enabled": false},"celebrityRecogImage": {"MediaType": "Image","Enabled": false},"contentModeratImage": {"MediaType": "Image","Enabled": false},"faceDetectionImage": {"MediaType": "Image","Enabled": false}}},"Input": {"Media": {"Image": {"S3Bucket":"' + testing_env_variables['BUCKET_NAME'] +'","S3Key":"' + testing_env_variables['SAMPLE_IMAGE'] + '"}}}}'),
        # Test image processing workflow with all operators enabled
        ('{"Name":"ImageWorkflow","Configuration": {"ValidationStage": {"MediainfoImage": {"Enabled": true}},"RekognitionStage": {"faceSearchImage": {"MediaType": "Image","Enabled": true, "CollectionId": "' + testing_env_variables['FACE_COLLECTION_ID'] + '"},"labelDetectionImage": {"MediaType": "Image","Enabled": true},"celebrityRecogImage": {"MediaType": "Image","Enabled": true},"contentModeratImage": {"MediaType": "Image","Enabled": true},"faceDetectionImage": {"MediaType": "Image","Enabled": true}}},"Input": {"Media": {"Image": {"S3Bucket":"' + testing_env_variables['BUCKET_NAME'] +'","S3Key":"' + testing_env_variables['SAMPLE_IMAGE'] + '"}}}}'),
