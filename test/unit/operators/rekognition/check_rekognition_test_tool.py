...
class CheckRekognitionTestTool:
    ...
    def test_complete_status(self):
        ...
        response = self.subject_under_test.lambda_handler(input_parameter, {})
    ...
    def test_empty_job_id(self):
        ...
        with pytest.raises(self.MasExecutionError) as err:
            self.subject_under_test.lambda_handler(input_parameter, {})
        assert err.value.args[0]['Status'] == 'Error'
    ...
    def test_job_status_succeeded_paginated(self, stub):
        ...
        assert self.subject_under_test.DataPlane.store_asset_metadata.call_args_list[0][1]['paginate'] == True
        assert self.subject_under_test.DataPlane.store_asset_metadata.call_args_list[0][1]['end'] == False
        ...
        assert self.subject_under_test.DataPlane.store_asset_metadata.call_args_list[1][1]['paginate'] == True
        assert self.subject_under_test.DataPlane.store_asset_metadata.call_args_list[1][1]['end'] == True
        self.reset_subject_under_test()