...
def workflow_configs(create_face_collection):
    return [
        ...
        ('{"Name":"ImageWorkflow","Configuration": {"RekognitionStage": {"faceSearchImage": {"MediaType": "Image","Enabled": false, "CollectionId": "' + FACE_COLLECTION_ID + '"},"labelDetectionImage": {"MediaType": "Image","Enabled": false},"celebrityRecognitionImage": {"MediaType": "Image","Enabled": false},"contentModerationImage": {"MediaType": "Image","Enabled": false},"faceDetectionImage": {"MediaType": "Image","Enabled": false}}},"Input": {"Media": {"Image": {"S3Bucket":"' + BUCKET_NAME +'","S3Key":"' + SAMPLE_IMAGE + '"}}}}'),
        # Test image processing workflow with all operators enabled
        ('{"Name":"ImageWorkflow","Configuration": {"RekognitionStage": {"faceSearchImage": {"MediaType": "Image","Enabled": true, "CollectionId": "' + FACE_COLLECTION_ID + '"},"labelDetectionImage": {"MediaType": "Image","Enabled": true},"celebrityRecognitionImage": {"MediaType": "Image","Enabled": true},"contentModerationImage": {"MediaType": "Image","Enabled": true},"faceDetectionImage": {"MediaType": "Image","Enabled": true}}},"Input": {"Media": {"Image": {"S3Bucket":"' + BUCKET_NAME +'","S3Key":"' + SAMPLE_IMAGE + '"}}}}'),
