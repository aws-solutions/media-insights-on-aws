...
export class WorkflowApiStack extends cdk.NestedStack {
    ...
    constructor(scope: Construct, id: string, props: cdk.NestedStackProps) {
        super(scope, id, { ...props, description: "aws-media-insights-engine version %%VERSION%%. This AWS CloudFormation template provisions the REST API for the Media Insights Engine control plane" });
