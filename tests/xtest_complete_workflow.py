...
def rek_workflow_configs(testing_env_variables):
    return [
        ...
        ('{"Name":"ImageWorkflow","Configuration": {"RekognitionStage": {"faceSearchImage": {"MediaType": "Image","Enabled": false, "CollectionId": "' + testing_env_variables['FACE_COLLECTION_ID'] + '"},"labelDetectionImage": {"MediaType": "Image","Enabled": false},"celebrityRecognitionImage": {"MediaType": "Image","Enabled": false},"contentModerationImage": {"MediaType": "Image","Enabled": false},"faceDetectionImage": {"MediaType": "Image","Enabled": false}}},"Input": {"Media": {"Image": {"S3Bucket":"' + testing_env_variables['BUCKET_NAME'] +'","S3Key":"' + testing_env_variables['SAMPLE_IMAGE'] + '"}}}}'),
        # Test image processing workflow with all operators enabled
        ('{"Name":"ImageWorkflow","Configuration": {"RekognitionStage": {"faceSearchImage": {"MediaType": "Image","Enabled": true, "CollectionId": "' + testing_env_variables['FACE_COLLECTION_ID'] + '"},"labelDetectionImage": {"MediaType": "Image","Enabled": true},"celebrityRecognitionImage": {"MediaType": "Image","Enabled": true},"contentModerationImage": {"MediaType": "Image","Enabled": true},"faceDetectionImage": {"MediaType": "Image","Enabled": true}}},"Input": {"Media": {"Image": {"S3Bucket":"' + testing_env_variables['BUCKET_NAME'] +'","S3Key":"' + testing_env_variables['SAMPLE_IMAGE'] + '"}}}}'),
        ...
        ('{"Name":"MieCompleteWorkflow","Configuration":{"defaultVideoStage":{"faceDetection":{"Enabled":false},"celebrityRecognition":{"Enabled":false},"GenericDataLookup":{"Enabled":true, "Bucket":"' + testing_env_variables['BUCKET_NAME'] + '","Key":"' + testing_env_variables['SAMPLE_JSON'] + '"},"labelDetection":{"Enabled":false},"personTracking":{"Enabled":false},"Mediaconvert":{"Enabled":false},"contentModeration":{"Enabled":false},"faceSearch":{"Enabled":false}}},"Input": {"Media": {"Video": {"S3Bucket":"' + testing_env_variables['BUCKET_NAME'] +'","S3Key":"' + testing_env_variables['SAMPLE_VIDEO'] + '"}}}}'),
