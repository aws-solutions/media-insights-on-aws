...
cp "$workflows_dir/aws-content-analysis-workflow.yaml" "$dist_dir/MieCompleteWorkflow.template"
...
cp "$workflows_dir/rekognition.yaml" "$dist_dir/rekognition.template"
cp "$workflows_dir/aws-content-analysis-workflow.yaml" "$dist_dir/MieCompleteWorkflow.template"
cp "$source_dir/consumers/elastic/aws-content-analysis-elasticsearch.yaml" "$dist_dir/media-insights-elasticsearch.template"
cp "$source_dir/consumers/elastic/aws-content-analysis-elasticsearch.yaml" "$dist_dir/media-insights-s3.template"
find "$dist_dir"
